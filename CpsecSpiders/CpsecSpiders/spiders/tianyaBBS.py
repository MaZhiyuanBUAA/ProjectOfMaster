...
class tianyaBBSspider(CrawlSpider):
    ...
    def parse_item(self, response):
        ...
        l = ItemLoader(item=CpsecSpiderItem(), response=response)
        ...
        article_author  =  sel.xpath('//div[@id="post_head"]/div[1]/div[@class="atl-info"]/span[1]/a/text()').extract()
        article_clik_num  =  sel.xpath('//div[@id="post_head"]/div[1]/div[@class="atl-info"]/span[3]/text()').extract()
        article_reply_num =  sel.xpath('//div[@id="post_head"]/div[1]/div[@class="atl-info"]/span[4]/text()').extract()
